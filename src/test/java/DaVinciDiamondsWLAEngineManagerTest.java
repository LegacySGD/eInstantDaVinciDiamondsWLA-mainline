...
public class DaVinciDiamondsWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(DaVinciDiamondsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DaVinciDiamondsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DaVinciDiamondsWLAIW/InitOutcome.xml").getDocumentElement();
